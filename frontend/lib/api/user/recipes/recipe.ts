...
export class RecipeAPI extends BaseCRUDAPI<CreateRecipe, Recipe, Recipe> {
  ...
  async createOneByHtmlOrJson(
    ...
    return this.streamRecipeCreate(routes.recipesCreateFromHtmlOrJson, { data, includeTags, includeCategories, url, translateLanguage },
      onProgress,
    );
  }
  ...
  async createOneByUrl(
    ...
    return this.streamRecipeCreate(routes.recipesCreateUrl, { url, includeTags, includeCategories, translateLanguage }, onProgress);
  }
